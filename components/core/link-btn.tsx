...
export const LibraryLink = () => {
  return (
    <Link
      href="/dash"
      className={cn(linkClasses, "border bg-transparent text-foreground hover:bg-muted hover:shadow-sm")}
    >
      &#x2190; Back to library
    </Link>
  );
...
export const LandingPageLink = () => {
  return (
    <Link href="/" className={cn(linkClasses, "border-primary text-foreground shadow-sm")}>
      &#x2190; Go to landing page
    </Link>
  );
};
