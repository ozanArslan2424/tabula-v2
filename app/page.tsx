                        ...
                        <div className="mx-auto grid max-w-[1300px] gap-4 px-4 sm:px-6 md:grid-cols-2 md:gap-16 md:px-10">
                            ...
                            <div className="flex flex-col items-start space-y-6">
                                ...
                                <p className="mx-auto max-w-[700px] text-foreground md:text-lg">
                                    Tabula Notes is a note-taking app designed
                        ...
                        <div className="flex flex-col items-center justify-center space-y-4 text-center">
                            <div className="space-y-2">
                                ...
                                <p className="max-w-[900px] text-foreground  md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                    Tabula Notes offers a suite of features to
                                    help you capture, organize, and access your
                                    notes with ease.
                                </p>
                            </div>
                        </div>
                        <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
                            <div className="grid gap-1">
                                ...
                                <p className="text-sm text-foreground">
                                    Access your notes from anywhere, on any
                                    device. Tabula Notes automatically syncs
                                    your data across all your devices through
                                    your account.
                                </p>
                            </div>
                            <div className="grid gap-1">
                                ...
                                <p className="text-sm text-foreground">
                                    Write notes in universal Markdown format.
                                    Tabula Notes renders your notes beautifully.
                                </p>
                            </div>
                            <div className="grid gap-1">
                                <h3 className="text-lg font-bold">
                                ...
                                <p className="text-sm text-foreground">
                                    Organize your notes with notebooks, and
                                    horizontal scrolling just like a real
                                    notebook. Find your notes with ease, using
                            ...
                            <div className="grid gap-1">
                                ...
                                <p className="text-sm text-foreground">
                                    Your notes are stored securely. Tabula Notes
                                    respects your privacy and never shares your
                                    data.
                                </p>
                            </div>
                            <div className="grid gap-1">
                                ...
                                <p className="text-sm text-foreground">
                                    Write and store code snippets in special
                                    code books. Tabula Notes supports syntax
                                    highlighting. Your snippets have never
                            ...
                            <div className="grid gap-1">
                                ...
                                <p className="text-sm text-foreground">
                                    Share notes with your team and collaborate
                                    in real-time. Manage permissions and track
                                    changes.
                                    <br />
                                    <i className="text-muted-foreground">
                                        Currently being implemented.
                    ...
                    <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
                        <div className="space-y-3">
                            ...
                            <p className="mx-auto max-w-[600px] text-foreground  md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                ...
                                access your notes from anywhere with Tabula
                                Notes.
                            </p>
                        </div>
